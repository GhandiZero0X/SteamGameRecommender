...
def display_recommendations(user_id, recommender, interactions_matrix, n_recommendations=5):
    # Get the index of the user in the interaction matrix
    user_idx = interactions_matrix.index.get_loc(user_id)
    
    # Get recommendations for the user
    recommendations = recommender.get_recommendations(user_idx, n_recommendations)
